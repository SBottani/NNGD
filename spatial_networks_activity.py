...
def output_graphs(net,set1,set2,restrict,set1_title="",set2_title=""):
  ...
  if plot_distribution is True :
      ...
      nngt.plot.degree_distribution(
          net, ["in", "out"], num_bins='auto', nodes=set1, show=False, title=set1_title)
      nngt.plot.degree_distribution(
          net, ["in"], num_bins='auto', nodes=set1, show=False, title=set1_title)
      nngt.plot.degree_distribution(
          net, ["out"], num_bins='auto', nodes=set1, show=False, title=set1_title)

      nngt.plot.degree_distribution(
          net, ["in", "out"], num_bins='auto', nodes=set2, show=False, title=set2_title)
      nngt.plot.degree_distribution(
          net, ["in"], num_bins='auto', nodes=set2, show=False, title=set2_title)
      nngt.plot.degree_distribution(
          net, ["out"], num_bins='auto', nodes=set2, show=False, title=set2_title)
...
def with_obstacles(shape,params = {"height": 250., "width": 250.},filling_fraction = 0.4):
    ...
    restrict  = [(top_groups_name_list, top_groups_name_list), 
                ...
                ("bottom", "bottom")]
    output_graphs(net,top_neurons,bottom_neurons,restrict,"Top neurons","Bottom neurons")

    # Simulate with NEST 
    activity_simulation(net,pop,sim_duration) 

#########################################################################################
def with_obstacles_EI(shape,params = {"height": 250., "width": 250.},filling_fraction = 0.4):
    '''
